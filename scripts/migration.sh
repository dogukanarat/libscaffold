...
perform_rename() {
    ...
    local files_to_update=(
        ...
        "include/${old_snake}/export.h"
        "include/${old_snake}/config.h.in"
        "include/${old_snake}/version.h.in"
        ...
        "templates/workflows/format-check.yml"
        "templates/workflows/static-analysis.yml"
    )
